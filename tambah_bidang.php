			...
			<div class="row">
				<div class="col bg-white rounded p-5 mb-2 shadow-box">
					<form action="" method="POST">
						...
						<button type="submit" class="btn btn-success" name="submit">Tambah Bidang &ensp;<img src="icon/fix_data.png"></button>
							&nbsp;
							<a href="bidang.php" class="btn btn-danger">Kembali &ensp;<img src="icon/previous.png"></a>
						</div>
					</form>
				</div>
			</div>
