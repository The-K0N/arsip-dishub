			...
			<!-- Search -->
				<div class="row content-center menu">
					...
					<div class="col-md-3 mt-3 mb-2">
						...
						<a class="btn btn-success text-center" href="tambah_bidang.php"><img src="icon/add_data.png">&nbsp;&nbsp; Tambah Bidang </a>
						&ensp;
							...
							<tbody>
								...
								<?php foreach ($isi as $row) : ?>
									<tr class="text-center">
										...
										<td class="aksi">
											<a href="ubah_bidang.php?id=<?= $row['id_bidang']; ?>" onclick="return confirm('Apakah Anda Ingin Mengubah Data ?');" class="btn btn-light text-center text-white">
												<img src="icon/edit_data.png">
											</a>
											&ensp;
											<a href="hapus_bidang.php?id=<?= $row['id_bidang']; ?>" onclick="return confirm('Apakah Anda Ingin Menghapus Data ?');" class="btn btn-light text-center">
