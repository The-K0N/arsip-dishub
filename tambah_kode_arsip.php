			...
			<div class="row">
				<div class="col bg-white rounded p-5 mb-2 shadow-box">
					<form action="" method="POST">
						<div class="row">
							<div class="col" style="font-weight: bolder; font-family: arial;">
						...
						<div class="form-group mt-3">
							<button type="submit" class="btn btn-success" name="submit">Tambah Kode Arsip &ensp;<img src="icon/fix_data.png"></button>
							&nbsp;
							<a href="kode_arsip.php" class="btn btn-danger">Kembali &ensp;<img src="icon/previous.png"></a>
						</div>
					</form>
				</div>
			</div>
