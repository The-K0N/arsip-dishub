			...
			<div class="row">
				<div class="col bg-white rounded p-5 mb-2 shadow-box">
					<form action="" method="POST">
						<div class="row" style="font-weight: bolder; font-family: arial;">
							<div class="col">
						...
						<div class="form-group mt-3">
							<button type="submit" class="btn btn-success" name="submit"> Ubah Kode Arsip &ensp;<img src="icon/fix_data.png"></button>
							&nbsp;
