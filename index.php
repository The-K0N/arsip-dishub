		...
		<div class="container-fluid">
			<div class="row marquee justify-content-center">
				<div class="col-md-6 mt-2 mb-3">
					<marquee scrollamount="10" loop="infinite" direction="left" class="nav-link text-white p-2 bg-warning rounded text-center">
			...
			<div class="row content-center menu">
				...
				<div class="col-md-3 mt-3 mb-2">
					...
					<a class="btn btn-success text-center" href="input.php"><img src="icon/add_data.png">&ensp;&nbsp; Tambah Data Arsip </a>
					&ensp;
					...
					<table rules="all" border="2" cellpadding="10" cellspacing="0" class="table bg-white table-bordered table-hover table-primary shadow-box">
						...
						<?php foreach ($isi as $row) : ?>
							<tr class="text-center">
								...
								<td class="aksi">
									<a href="ubah.php?id=<?= $row['id_arsip_dokumen']; ?>" onclick="return confirm('Apakah Anda Ingin Mengubah Data ?');" class="m-1 btn btn-light text-center text-white">
										<img src="icon/edit_data.png">
									</a>
									<a href="hapus.php?id=<?= $row['id_arsip_dokumen']; ?>" onclick="return confirm('Apakah Anda Ingin Menghapus Data ?');" class="m-1 btn btn-light text-center">
